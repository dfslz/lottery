$(function () {
    ...
    */
    ...
    function getRewards() {
        var uid = getCookie("page");
        $.ajax({
            url: "https://lzblog.club/lottery/php/getInfo.php",
            type: "POST",
            dataType: "json",
            data: {
                id: uid
            ...
            success: function (data, status) {
                ...
                for (var i = 0; i < len - 1; ++i) {
                    ...
                    img.alt = data[i];
                    if (i == 0) {
                        img.classList = "lucky_prize_show display";
                    } else {
                        img.classList = "lucky_prize_show none";
                    }
